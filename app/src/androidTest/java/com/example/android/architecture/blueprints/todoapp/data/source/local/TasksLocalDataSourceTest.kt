...
@RunWith(AndroidJUnit4::class) @LargeTest class TasksLocalDataSourceTest {
    ...
    @Test fun saveTask_retrievesTask() = runBlockingSilent{
        // Given a new task
    ...
    @Test fun completeTask_retrievedTaskIsComplete() = runBlockingSilent {
    ...
    @Test fun clearCompletedTask_taskNotRetrievable() = runBlockingSilent {
    ...
    @Test fun deleteAllTasks_emptyListOfRetrievedTask() = runBlockingSilent {
        with(localDataSource) {
    ...
    @Test fun getTasks_retrieveSavedTasks() = runBlockingSilent {
        with(localDataSource) {
