...
import com.example.android.architecture.blueprints.todoapp.data.source.RemoteDataNotFoundException
...
object TasksRemoteDataSource : TasksDataSource {
    ...
    override suspend fun getTask(taskId: String): Result<Task> {
        ...
        delay(SERVICE_LATENCY_IN_MILLIS) // Simulate network by delaying the execution.
        return if (task != null) Result.Success(task) else Result.Error(RemoteDataNotFoundException())
    }
